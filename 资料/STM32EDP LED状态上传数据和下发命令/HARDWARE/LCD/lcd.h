...
//void LCD_LEDOPEN(void);                                      //打开LCD的LED
void LCD_memu1(void);             //LCD显示界面1
...
void mode2(void);
void mode3(void);
void showhanzi16(unsigned int x,unsigned int y,unsigned char index,const unsigned char *temp1);//16*16汉字
