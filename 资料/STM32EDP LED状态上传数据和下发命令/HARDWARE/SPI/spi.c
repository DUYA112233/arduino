 ...
 void SPI1_Init(void)
{
	...
	GPIO_Init(GPIOA, &GPIO_InitStructure);
 	...
 	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6;         //MISO浮空模式
    ...
    GPIO_ResetBits(GPIOB, GPIO_Pin_8);//PB8	LCD_RST*/
	 ...
	 RCC_APB2PeriphClockCmd(	RCC_APB2Periph_GPIOB, ENABLE );//PORTB时钟使能 
	  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1;                 //PTB01 打开液晶屏LED
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; 
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 
    GPIO_Init(GPIOB, &GPIO_InitStructure);
...
//	
//	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_14;         //MISO浮空模式
//	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;  
//	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
//	GPIO_Init(GPIOB, &GPIO_InitStructure);
//	 
//  GPIOC_date.GPIO_Mode=GPIO_Mode_Out_PP;               //设置推挽输出模式
//  GPIOC_date.GPIO_Pin=GPIO_Pin_6|GPIO_Pin_7;                      //初始化Pin6 7 (CE=PIN7 CSN=PIN6)
//  GPIOC_date.GPIO_Speed=GPIO_Speed_50MHz;              //设置时钟
//  GPIO_Init(GPIOB,&GPIOC_date);    
//		
		
//		RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOD,ENABLE);		 //PD2=IRQ 设置输入模式
